...
DEFINE_TWO_KEY(KC_F, KC_G);
DEFINE_TWO_KEY(KC_H, KC_J);
...
combo_t key_combos[] = {
    ...
    TWO_KEY_COMBO(BSPC_RS, KC_B, KC_APP),
    TWO_KEY_COMBO(SPC_RS, KC_N, KC_APP),

    TWO_KEY_COMBO(KC_F, KC_G, OSL_RSE),
    TWO_KEY_COMBO(KC_H, KC_J, OSL_NAV),
