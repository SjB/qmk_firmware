...
SJB_DEFINE_KEY(CK_TG_NAV, LT_BSPC, KC_F);
SJB_DEFINE_KEY(CK_TG_RSE, LT_SPC, KC_J);

SJB_DEFINE_KEY(CK_TG_NUM, LT_BSPC, KC_D);
SJB_DEFINE_KEY(CK_TG_MOUSE, LT_SPC, KC_K);

SJB_DEFINE_KEY(CK_THUMB_SFT, LT_SPC, ENT_GUI);
SJB_DEFINE_KEY(CK_THUMB_TAB, LT_BSPC, ESC_CTL);
...
combo_t key_combos[] = {
    ...
    SJB_COMBO(CK_THUMB_SFT, OSM_SFT),
    SJB_COMBO(CK_THUMB_TAB, TAB_ALT),
