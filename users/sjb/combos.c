...
SJB_DEFINE_KEY(CK_VRALT, KC_P, KC_QUOT);
...
SJB_DEFINE_KEY(CK_RALT, KC_J, KC_QUOT);
SJB_DEFINE_KEY(CK_RGUI, KC_J, KC_L);
SJB_DEFINE_KEY(CK_RCTL, KC_J, KC_K);
SJB_DEFINE_KEY(CK_RCG , KC_J, KC_K, KC_L);
SJB_DEFINE_KEY(CK_RCA , KC_J, KC_K, KC_QUOT);
SJB_DEFINE_KEY(CK_RCGA, KC_J, KC_K, KC_L, KC_QUOT);
