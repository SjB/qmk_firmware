...
#define LEFT_SYS_ROW_3 OSM_MEH , QK_LOCK, G(KC_MUTE) , KC_LCBR, KC_RCBR
...
#define RIGHT_SYS_ROW_3 KC_LCBR, KC_RCBR, G(KC_SPC) , QK_LOCK, OSM_MEH

#define LEFT_NAV_ROW_1 KC_MPRV , KC_VOLU , KC_UP   , KC_PGUP , KC_HOME
#define LEFT_NAV_ROW_2 KC_MNXT , KC_LEFT , KC_DOWN , KC_RIGHT, CW_TOGG
