...
#define LEFT_QW_ROW_2 KC_A, KC_S, KC_D, KC_F, KC_G
#define LEFT_QW_ROW_3 KC_Z, KC_X, KC_C, KC_V, KC_B

#define RIGHT_QW_ROW_1 KC_Y, KC_U, KC_I   , KC_O  , KC_P
#define RIGHT_QW_ROW_2 KC_H, KC_J, KC_K   , KC_L  , KC_SCLN
...
#define LEFT_SYS_ROW_1 OSM_RALT, SB_TCM , G(KC_SPC), KC_LBRC, KC_RBRC
#define LEFT_SYS_ROW_2 OSM_ALT , OSM_GUI, OSM_CTL  , KC_LPRN, KC_RPRN
#define LEFT_SYS_ROW_3 OSM_MEH , CW_TOGG, KC_TAB   , KC_LCBR, KC_RCBR

#define RIGHT_SYS_ROW_1 KC_LBRC, KC_RBRC, G(KC_SPC), KC_APP, OSM_RALT
#define RIGHT_SYS_ROW_2 KC_LPRN, KC_RPRN, OSM_CTL  , OSM_GUI, OSM_ALT
#define RIGHT_SYS_ROW_3 KC_LCBR, KC_RCBR, KC_TAB   , CW_TOGG, OSM_MEH
...
#define RIGHT_NAV_ROW_2 OSM_SFT , KC_LEFT, KC_DOWN, KC_RIGHT, KC_MNXT
