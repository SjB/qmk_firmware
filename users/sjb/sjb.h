...
#define LEFT_QW_ROW_2  LGUI_T(KC_A) , ALT_T(KC_S) , LSFT_T(KC_D) , CTL_T(KC_F) , LT_RS(KC_G)
#define LEFT_QW_ROW_3  KC_Z , KC_X , KC_C , KC_V , KC_B

#define RIGHT_QW_ROW_1 KC_Y , KC_U , KC_I , KC_O , KC_P
#define RIGHT_QW_ROW_2 LT_RS(KC_H) , CTL_T(KC_J) , RSFT_T(KC_K) , ALT_T(KC_L) , RGUI_T(KC_SCLN)
...
#define MOUSE_ROW_1 KC_VOLU , KC_MS_BTN3 , KC_MS_U    , KC_MS_BTN4 , KC_MS_BTN5
...
#define LEFT_MOUSE_THUMB_CLUSTER(LAYER) KC_MS_BTN2, LT_LW(KC_MS_BTN1), TO(LAYER)
#define LOWER_THUMB_CLUSTER(LAYER) _______, LT_LW(KC_DEL) , TO(LAYER)
