...
#define RIGHT_QW_ROW_2 KC_H, KC_J, KC_K   , KC_L  , KC_QUOT
...
#define LEFT_RAISE_ROW_3 KC_BSLS, KC_PIPE, KC_GRV,  KC_TILD, KC_COLN

#define RIGHT_RAISE_ROW_1 S(KC_6), S(KC_7), S(KC_8), S(KC_9), S(KC_0)
#define RIGHT_RAISE_ROW_2 KC_6   , KC_7   , KC_8   , KC_9   , KC_0
#define RIGHT_RAISE_ROW_3 KC_SCLN, KC_UNDS, KC_MINS, KC_PLUS, KC_EQL
