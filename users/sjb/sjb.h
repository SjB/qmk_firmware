...
#define MOUSE_ROW_1 KC_BTN7 , KC_BTN4 , KC_MS_U , KC_BTN5 , KC_BTN6
#define MOUSE_ROW_2 KC_WH_U , KC_MS_L , KC_MS_D , KC_MS_R , KC_ACL0
#define MOUSE_ROW_3 KC_WH_D , KC_WH_L , KC_BTN3 , KC_WH_R , KC_ACL1
...
#define LOWER_THUMB_CLUSTER(LAYER) _______, LT_RS(KC_DEL) , TO(LAYER)
