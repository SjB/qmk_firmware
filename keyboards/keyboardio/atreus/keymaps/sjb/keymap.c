...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_wrapper(
     ...
     KC_LBRC , KC_GRV, KC_BSLS , LEFT_TRANSPARENT_THUMB_CLUSTER(_QWERTY) ,
     RIGHT_TRANSPARENT_THUMB_CLUSTER(OSM(MOD_RALT)), KC_MINS , S(KC_EQL) , KC_RBRC
  ),
  [_RAISE] = LAYOUT_wrapper(
    ...
    TO(_LOWER) , KC_NO , KC_NO , LEFT_TRANSPARENT_THUMB_CLUSTER(_QWERTY) ,
    TRANSPARENT_THUMB_CLUSTER , KC_NO , KC_NO , KC_NO
  ),
  [_NUMPAD] = LAYOUT_wrapper(
    ...
    KC_SLEP , KC_NO , KC_NO , LEFT_TRANSPARENT_THUMB_CLUSTER(_QWERTY) ,
    TRANSPARENT_THUMB_CLUSTER , KC_DEL , KC_P0 , KC_PEQL
  )
};
