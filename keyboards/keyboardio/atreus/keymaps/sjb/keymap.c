...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_wrapper(
     ...
     TO(_LOWER), KC_PGUP, KC_PGDN , LEFT_TRANSPARENT_THUMB_CLUSTER(_QWERTY),
  ...
  [_RAISE] = LAYOUT_wrapper(
    ...
    TO(_RAISE), KC_PGUP, KC_PGDN , LEFT_TRANSPARENT_THUMB_CLUSTER(_QWERTY),
    RIGHT_TRANSPARENT_THUMB_CLUSTER, KC_NO, KC_NO, KC_NO
  ),
