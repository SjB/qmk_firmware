...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_wrapper(
     ...
     TO(_LOWER), KC_GRV, KC_BSLS , LEFT_TRANSPARENT_THUMB_CLUSTER(_QWERTY),
     RIGHT_TRANSPARENT_THUMB_CLUSTER, KC_MINS, S(KC_EQL), KC_EQL
  ),
  [_RAISE] = LAYOUT_wrapper(
    MOUSE_ROW_1                       , BLANK_ROW  ,
    MOUSE_ROW_2                       , NAV_VI_ROW ,
    MOUSE_ROW_3 , _______ , _______   , BLANK_ROW  ,

    TO(_RAISE), KC_WH_L, KC_WH_R, LEFT_TRANSPARENT_THUMB_CLUSTER(_QWERTY),
    RIGHT_TRANSPARENT_THUMB_CLUSTER, KC_PGUP, KC_PGDN, KC_NO
  ),
  [_NUMPAD] = LAYOUT_wrapper(
    ...
    S(KC_PSCR) , KC_PGUP, KC_PGDN, LEFT_TRANSPARENT_THUMB_CLUSTER(_QWERTY),
    RIGHT_TRANSPARENT_THUMB_CLUSTER, KC_DEL,KC_P0, KC_PEQL
  )
};
