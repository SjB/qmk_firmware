...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 [_QWERTY] = LAYOUT_wrapper(
  ...
  [_RAISE] = LAYOUT_wrapper(
    OSM(MOD_LGUI) , LEFT_SYMBOL_ROW_1          , RIGHT_SYMBOL_ROW_1 , OSM(MOD_RCTL) ,
    OSM(MOD_LSFT) , LEFT_NUM_ROW               , RIGHT_NUM_ROW      , OSM(MOD_LALT) ,
  ...
  [_NUMPAD] = LAYOUT_wrapper(
    OSM(MOD_LGUI) , FUNCPAD_ROW_1              , NUMPAD_ROW_1 , KC_DEL  ,
    OSM(MOD_LSFT) , FUNCPAD_ROW_2              , NUMPAD_ROW_2 , KC_INS  ,
    OSM(MOD_LALT) , FUNCPAD_ROW_3              , NUMPAD_ROW_3 , KC_PEQL ,
  ...
  [_MOUSE] = LAYOUT_wrapper(
    NK_TOGG , MOUSE_ROW_LEFT_1 , MOUSE_ROW_RIGHT_1 , KC_NO ,
    KC_NO   , MOUSE_ROW_LEFT_2 , MOUSE_ROW_RIGHT_2 , KC_NO ,
    KC_NO   , MOUSE_ROW_LEFT_3 , MOUSE_ROW_RIGHT_3 , KC_NO ,
